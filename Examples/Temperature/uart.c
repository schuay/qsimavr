...
// Martin Thomas:
// minor reformating
// minor updates for ATmega644 and ATmega164P/324P/644P
...
#error TX buffer size is not a power of 2
...
#elif defined(__AVR_ATmega64__) || defined(__AVR_ATmega128__) || defined(__AVR_ATmega1280__)
 /* ATmega with two USART */
 #define ATMEGA_USART0
 #define ATMEGA_USART1
 ...
 /* ATmega with one USART - still using old-style vector-labels */
 #define ATMEGA_USART0
 #define UART0_RECEIVE_INTERRUPT     SIG_USART_RECV
 #define UART0_TRANSMIT_INTERRUPT    SIG_USART_DATA
 #define UART0_STATUS   UCSR0A
 ...
 /* ATmega with two USART - still using old-style vector-labels */
 #define ATMEGA_USART0
 #define ATMEGA_USART1
 #define UART0_RECEIVE_INTERRUPT     SIG_USART_RECV
 #define UART1_RECEIVE_INTERRUPT     SIG_USART1_RECV
